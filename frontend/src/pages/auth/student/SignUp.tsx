...
export default function StudentSignUp() {
    ...
    return (
        <AuthShell title="Create your account" subtitle="Join the campus portal" illustration={<LottiePlayer animationData={study2Animation} style={{ width: '100%', height: 'auto', opacity: 0.9 }} />}>
            {form}
        </AuthShell>
    );
}
